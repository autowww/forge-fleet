# Repository companion — operator reference

_Dense reference material that used to live only on the repository root `README.md`. The [Fleet handbook home](../../README.md) stays a short product entry point._
...
| --- | --- |
| **Local developer** trying Fleet for the first time | **[Install locally](../learn-101/02-install-run-local-dev.md)** → **[First job](../learn-101/06-first-fleet-job.md)** (about **15 min** with Docker) |
| **Host operator** putting Fleet on bare metal / systemd | **[Host bootstrap](../learn-101/03-host-bootstrap.md)** → **[Git install](../learn-101/04-git-install.md)** |
| **API / automation author** | **[HTTP API](../reference/01-http-api-reference.md)** + **[Examples hub](../examples/README.md)** |
| **Enterprise / security reviewer** | **[Security](../operate-301/01-security.md)** + **[Architecture](../operate-301/03-architecture.md)** |
| **Maintainer / releaser** | **[Maintainers](../maintainers/README.md)** + **`scripts/update-fleet.sh`** (below) |

**Five-minute sanity check:** with a running server, **`curl http://127.0.0.1:18765/v1/version`** (and **`/v1/health`** when bearer policy allows) should return JSON—see **[Quickstarts](../learn-101/05-quickstarts.md)**.
...
|-------|----------|--------|
| **Start** | “Where do I go next?” routing | **[Start hub](README.md)** · **[Role routing table](01-start-here.md)** |
| **Learn 101** | First install + verification | **[Learn hub](../learn-101/README.md)** · **[Install locally](../learn-101/02-install-run-local-dev.md)** · **[First job](../learn-101/06-first-fleet-job.md)** · **[Quickstarts](../learn-101/05-quickstarts.md)** |
| **Build 201** | Workspaces, templates, Caddy fronts, recipes | **[Build hub](../build-201/README.md)** · **[Examples & recipes](../build-201/05-examples-and-recipes.md)** |
| **Operate 301** | Security + runbooks + architecture + incidents | **[Operate hub](../operate-301/README.md)** · **[Upgrade & remote ops](../operate-301/05-upgrade-release-and-remote-update.md)** |
| **Reference** | Protocols & env contracts | **[Reference hub](../reference/README.md)** · **[HTTP API](../reference/01-http-api-reference.md)** · **[Schemas/OpenAPI](../reference/02-schemas-and-openapi.md)** |
| **Examples** | Copy-paste by language / outcome | **[Examples hub](../examples/README.md)** |

**Maintainer transparency:** handbook maintenance notes (**screenshots**, OpenAPI parity checks, admin KPI design prompts) ship under **[Maintainers hub](../maintainers/README.md)**.
...
- **In-place git refresh** — `POST /v1/admin/git-self-update` ([HTTP API reference](../reference/01-http-api-reference.md) clarifies **`/opt`**, **`FLEET_GIT_ROOT`**, and **400** responses)

Detailed tables—including static **`/admin/…`** asset routes and host-metrics injection—live in **`[docs/reference/01-http-api-reference.md](../reference/01-http-api-reference.md)`**.

### Remote automation (`scripts/update-fleet.sh`)

From your **dev clone**, **`./scripts/update-fleet.sh --remote-git-self-update`** bumps/commits/pushes, then **`curl` POST** **`POST {FORGE_FLEET_BASE_URL}/v1/admin/git-self-update`** so remote hosts (**Granite**/certificator pairs, etc.) can fast-forward their install tree—see **`[docs/operate-301/05-upgrade-release-and-remote-update.md](../operate-301/05-upgrade-release-and-remote-update.md)`** for semantics.
...
Prereqs (**Docker CE + buildx**, Python ≥3.11, git, rsync, …): **`[docs/learn-101/03-host-bootstrap.md](../learn-101/03-host-bootstrap.md)`**. Then:
...
Hands-on narrative + troubleshooting: **`[docs/learn-101/04-git-install.md](../learn-101/04-git-install.md)`**.
...
- **`etc/containers/types.json`** defines **system/job/service** tiers + **`allow_docker_argv_jobs`** capabilities (**[container templates handbook](../build-201/02-container-templates.md)**).
...
TLS façade: **`[docs/build-201/03-caddy-systemd.md](../build-201/03-caddy-systemd.md)`** · **`scripts/install-caddy-fleet.sh`**.
...
Detailed recovery steps live in **[Operate 301 troubleshooting](../operate-301/04-troubleshooting.md)**.
