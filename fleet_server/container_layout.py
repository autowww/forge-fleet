...
def layout_paths_payload(data_dir: Path) -> dict[str, Any]:
    ...
    return {
        "fleet_data_dir": str(dd),
        "types_file": str(types_file(dd)),
        "services_dir": str(services_dir(dd)),
        "requirement_templates_file": str(container_templates.requirement_templates_file(dd)),
        "build_cache_file": str(container_templates.build_cache_file(dd)),
        "dockerfiles_root": str(container_templates.dockerfiles_allow_root(dd)),
    }
